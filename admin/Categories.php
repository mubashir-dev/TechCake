  ...
  <main role="main" class="col-md-8 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
      ...
      <button class="btn btn-primary">
        <a class ="text-white" href="http://localhost/TechCake/admin/create_category.php">Create Category
         </a> </button>
    </div>
    <table class="table table-light">
      ...
      <?php
            while ($data = mysqli_fetch_assoc($cate_list)) { ?>
              <tr>
                <td><?php echo $data['cate_id'];  ?></td>
                <td><?php echo $data['cate_title'];  ?></td>
                <td><?php echo $data['name'];  ?></td>
                <td> <button class="btn btn-primary btn-sm">
                  <a class="text-white" href="http://localhost/TechCake/admin/edit_category.php?cate_id=<?php echo $data['cate_id']; ?>"> Update </a></button></td>
                <td> <button class="btn btn-danger btn-sm text-dark"> <a class="text-white" href="http://localhost/TechCake/admin/delete_category.php?id=<?php echo $data['id']; ?>">Delete</a></button></td>                
              </tr>
            <?php
      } ?>
